...
def main():
    ...
    try:
        ...
        table_entry = s1.p4info_helper.buildTableEntry(
            ...
            match_fields={
                "hdr.ipv4.dstAddr": ("10.0.8.13", 32)
            },
            action_name="MyIngress.ipv4_forward",
            action_params={
                "dstAddr": "00:00:00:00:08:0d",
                "port": 133
            })
        ...
        table_entry = s1.p4info_helper.buildTableEntry(
            table_name="MyIngress.ipv4_lpm",
            match_fields={
                "hdr.ipv4.dstAddr": ("10.0.8.14", 32)
            },
            action_name="MyIngress.ipv4_forward",
            action_params={
                "dstAddr": "00:00:00:00:08:0e",
                "port": 132
            })
        s1.WriteTableEntry(table_entry)
        print("%s rule installed" % table_name)
        ...
        table_entry = s1.p4info_helper.buildTableEntry(
            table_name="MyIngress.ipv4_lpm",
            match_fields={
                "hdr.ipv4.dstAddr": ("10.0.8.15", 32)
            },
            action_name="MyIngress.ipv4_forward",
            action_params={
                "dstAddr": "00:00:00:00:08:0f",
                "port": 135
            })
        s1.WriteTableEntry(table_entry)
        print("%s rule installed" % table_name)
        ...
        table_entry = s1.p4info_helper.buildTableEntry(
            table_name="MyIngress.ipv4_lpm",
            match_fields={
                "hdr.ipv4.dstAddr": ("10.0.8.16", 32)
            },
            action_name="MyIngress.ipv4_forward",
            action_params={
                "dstAddr": "00:00:00:00:08:10",
                "port": 134
            })
        s1.WriteTableEntry(table_entry)
        print("%s rule installed" % table_name)
