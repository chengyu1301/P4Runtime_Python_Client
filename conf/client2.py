...
def choose_fwd_type(switch_instance):
    ...
    try:
        ...
        table_entry = switch_instance.p4info_helper.buildTableEntry(
            ...
            match_fields={
                "standard_metadata.ingress_port": (132, 133)
            },
...
def main():
    ...
    try:
        ...
        table_entry = s1.p4info_helper.buildTableEntry(
            table_name="MyIngress.ipv4_lpm",
            match_fields={
                "hdr.ipv4.dstAddr": ("10.0.2.7", 32)
            },
            action_name="MyIngress.ipv4_forward",
            action_params={
                "dstAddr": "00:00:00:00:02:07",
                "port": 135
            })
        s1.WriteTableEntry(table_entry)
        print("%s rule installed" % table_name)
        ...
        table_entry = s1.p4info_helper.buildTableEntry(
            table_name="MyIngress.ipv4_lpm",
            match_fields={
                "hdr.ipv4.dstAddr": ("10.0.2.8", 32)
            },
            action_name="MyIngress.ipv4_forward",
            action_params={
                "dstAddr": "00:00:00:00:02:08",
                "port": 134
            })
        s1.WriteTableEntry(table_entry)
        print("%s rule installed" % table_name)
